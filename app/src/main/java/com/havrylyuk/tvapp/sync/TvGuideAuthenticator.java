...
/**
 * Manages "Authentication" to TvGuide's backend service.  The SyncAdapter framework
...
public class TvGuideAuthenticator extends AbstractAccountAuthenticator {

    public TvGuideAuthenticator(Context context) {
        super(context);
    }
